...
urlpatterns = [
    ...
    path('<int:pk>', PostDetail.as_view(), name='news'),  # pk — это первичный ключ новости, который будет выводиться у нас в шаблон
    # изменил path('news/<int:pk>/edit', PostUpdateView.as_view(), name='news_update'),
